            ...
            <div class="left__wrapper">
                <div id="input_area">
                    <table id="input_table">
                        ...
                        <tbody>
                            <tr>
                                <td><select class="save-data need-clear no-input text-input" id="line_id"></select></td>
                    ...
                    <table id="input_table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><select class="save-data need-clear no-input text-input" id="category_id"></select></td>
                                <td><select class="save-data need-clear no-input text-input" id="stock_nonstock_id"></select></td>
                                <td><input class="save-data need-clear no-input text-input" id="quantity" /></td>
                                <td><select class="save-data need-clear no-input text-input" id="unit_id"></select></td>
                                <td><select class="save-data need-clear text-input" id="currency_unit_id"></select></td>
                    ...
                    <table id="input_table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><select class="save-data need-clear text-input" id="person_incharge_id"></select></td>
                                <td><select class="save-data need-clear no-input text-input" id="requester_id"></select></td>
                                <td><input type="date" class="save-data need-clear no-input text-input" id="quotation_request_date" /></td>
                                <td><select class="save-data need-clear text-input" id="type"></select></td>
            ...
            <table id="summary__table_left">
                <thead>
                    <tr>
                        ...
                        <th>Ringi No.</th>
                        <th>Approved No.</th>
                        <th><input id="search_input" placeholder="Search"/></th>
                    </tr>
                </thead>
                <tbody></tbody>
            </table>
            <table id="summary__table_right">
                <thead>
                    <tr>
                        <th>Product Vie Name</th>
                        <th>Product ID</th>
